...
\mbox{\hyperlink{classsf_1_1_socket}{sf\+::\+Socket}} \begin{DoxyVerb}\end{DoxyVerb}
...
\subsubsection{\texorpdfstring{SocketSelector()}{SocketSelector()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{sf::SocketSelector@{sf::SocketSelector}!SocketSelector@{SocketSelector}}
\index{SocketSelector@{SocketSelector}!sf::SocketSelector@{sf::SocketSelector}}
\subsubsection{\texorpdfstring{SocketSelector()}{SocketSelector()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\subsubsection{\texorpdfstring{$\sim$SocketSelector()}{~SocketSelector()}}
