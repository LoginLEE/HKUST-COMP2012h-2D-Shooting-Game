...
{\bfseries{Special Note for OS X\+:}} Apple only supports choosing between either a legacy context (Open\+GL 2.\+1) or a core context (Open\+GL version depends on the operating system version but is at least 3.\+2). Compatibility contexts are not supported. Further information is available on the 
%% AME https://developer.apple.com/opengl/capabilities/index.html
...
\subsubsection{\texorpdfstring{ContextSettings()}{ContextSettings()}}
